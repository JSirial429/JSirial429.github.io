<!-- ***********************************************************************************
  Page Name  : Company page Program 5
  Author     : Jorge Sirias 
...
<html>
  ...
  <head>
    ...
    <title>Sirias Jorge Pgm 5 </title>
  ...
  <!--------------------------------Tool Tip---------------------------------->
    ...
    <body>
     ...
     <!----------------------------Company Header-------------------------------------->
      <table>
        ...
        <tr>
          ...
          <div align="center">
            ...
            <p style="font-size:60px ; background-color:orangered ; color:seagreen">The Comix Shoppe</p> 
      ...
      <form action="controller5.php" method="post"> <!-- Form O -->

        <table width="100%" border="5" bordercolor="orangered">
          ...
          <tr> <!-------------------------1st row O----------------------->
            ...
            <td>
              ...
              <table border="0"> 
                ...
                <td valign="middle" align="left" style="color:seagreen;"><!----------Telephone &nbsp;------------>
            ...
            <div align="center">            
              ...
              <table border="0">
                ...
                <td "text-align:left" style="color:seagreen;"> <input type="checkbox" name="DCpublisher" <?php if ($DCpublisher == "DC") echo checked;?>  value="DC">DC  &nbsp;  &nbsp;  &nbsp; </td>
          ...
          <tr> <!--------- 2nd row O ------------------->
            ...
            <td>
              ...
              <table border="0">
                ...
                <td valign="middle" align="left" style="color:seagreen;"><!-----------Last Name &nbsp;----------->  
            ...
            <td>
              ...
              <div align="center">
                ...
                <table border="0">
                  ...
                  <td "text-align:left" style="color:seagreen;"> <input type="checkbox" name="Mpublisher" <?php if ($Mpublisher == "Marvel") echo checked;?>  value="Marvel">Marvel  </td>
           ...
           <tr> <!------------ 3rd row O --------------->
            ...
            <td>
              ...
              <table border="0">
                ...
                <td valign="middle" align="left" style="color:seagreen;"><!---------First Name &nbsp;---->

                  <div class="tooltip">First Name &nbsp;

                    <span class="tooltiptext"><font color="white">Enter First Name</span></font>
            ...
            <td>
              ...
              <div align="center">
                ...
                <table border="0">
                  ...
                  <td "text-align:left" style="color:seagreen;"> <input type="checkbox" name="Ipublisher" <?php if ($Ipublisher == "Image") echo checked;?>  value="Image">Image  &nbsp; </td>
          ...
          <tr> <!--------------------- 4th row O----------------------->
            ...
            <td>
              ...
              <table border="0">
                ...
                <td "text-align:left" style="color:seagreen;"><!------Email  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;----->

                  <div class="tooltip">Email  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
                
                    <span class="tooltiptext"><font color="white">VALID Emails ONLY!</span></font>
            ...
            <td>
              ...
              <div align="center">
                ...
                <table border="0">
                  ...
                  <td "text-align:left" style="color:seagreen;"> <input type="checkbox" name="Vpublisher" <?php if ($Vpublisher == "Valiant") echo checked;?>  value="Valiant">Valiant  &nbsp;  &nbsp; </td>
          ...
          <tr> <!-----------------------5th row O-------------------->
            ...
            <td>
              ...
              <table border="0">
                ...
                <td "text-align:left" style="color:seagreen;"><!-----Requests  &nbsp;------>

                  <div class="tooltip">Requests  &nbsp;

                    <span class="tooltiptext"><font color="white">Tell us of any requirements or considerations</font></span>
                ...
                <td valign="middle" align="center"> 
                  ...
                  <textarea name="requests" placeholder="Requests" rows="5" cols="23"><?php echo $requests ?></textarea>
            ...
            <td>
              ...
              <div align="center">
                ...
                <table border="0">
                  ...
                  <td "text-align:left" style="color:seagreen;"> <input type="checkbox" name="DHpublisher" <?php if ($DHpublisher == "Dark Horse") echo checked;?>  value="Dark Horse">Dark Horse  &nbsp; </td>
                  <td valign="middle" align="left">
        ...
        <table border="0">
          ...
          <tr>
            ...
            <td>
              ...
              <input type="submit" name="LEADSM"   value="LEADS MANAGER">
