<!-- ***********************************************************************************
  Page Name  : Company page Program 3
  Author       : Jorge Sirias 
...
<html>
  ...
  <head>
    ...
    <body>
      ...
      <table>
        ...
        <tr>
          ...
          <div align="center">
            ...
            <p style="font-size:60px ; background-color:red ; color:white">The Comix Shoppe</p> 
      ...
      <form action="controller3.php" method="post"> <!-- Form O -->
            ...
            <td>
              ...
              <table border="0">
                ...
                <td valign="middle" align="center"> 
                  ...
                  <textarea name="requests" style="width:81%; height:100%;"><?php echo $requests ?></textarea>
