...
<html>
  ...
  <head>
    ...
    <title>Sirias Jorge Controller4.php</title>

  </head>

  <body onload = "currentTime(); help();">

    <?php
        //echo "This is controller 4"."<br>";
       ...
       /*
        echo "This is conroller4.php<br>";
        echo "<br>";
        ...
        */ 
        ...
        //echo "The SQL connection has been closed";        
        //include("pgm4.php");
